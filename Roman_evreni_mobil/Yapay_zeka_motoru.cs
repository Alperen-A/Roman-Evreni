...
{
    // Kendi anahtarini buraya yapistir
    private static readonly string Api_key = "AIzaSyBboKUPgkQHUy1mNbQmnc4Hax3zgxotKoY"; 

    public static async Task<string> Tavsiye_al(string Soru, string Evren_verisi_json)
    {
        // En kararli surum olan v1 ve ana modeli kullaniyoruz
        string Url = $"https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key={Api_key}";

        using var Client = new HttpClient();
        
        // Asistana verdigimiz gizli komutlari büyük harf olmadan yaziyoruz
       string Sistem_komutu = @"Sen profesyonel bir fantastik roman yazar asistanisin.
Gorev 1: Kullanici sana uzun bir hikaye notu veya paragraf atarsa, icindeki karakterleri ve mekanlari analiz et.
...
Gorev 4: Eger listeye eklenecek bir sey yoksa normal sohbet et ve tavsiye ver.";
